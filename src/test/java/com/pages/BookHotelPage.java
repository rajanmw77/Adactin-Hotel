...
public class BookHotelPage extends BaseClass{
	...
	public void bookHotel(String firstName, String lastName, String address, String ccNo, String ccType,
		...
		elementSendKeys(getBillAdd(), address);
		elementSendKeys(getCard(), ccNo);
		selectOptionByValue(getCrdtype(), ccType);
		selectOptionByAttribute(getCrdmnth(), expMonth);
		selectOptionByValue(getCrdyr(), expYear);
